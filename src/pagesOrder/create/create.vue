...
<template>
  <scroll-view scroll-y class="viewport">
    <!-- 收货地址 -->
    <navigator v-if="selectAdress" class="shipment" hover-class="none" url="/pagesMember/address/address?from=order">
      <view class="user"> {{ selectAdress?.receiver }} {{ selectAdress.contact }} </view>
      <view class="address">{{ selectAdress.fullLocation }} {{ selectAdress?.address }} </view>
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    ...
    <view class="button" :class="{ disabled: !selectAdress?.id }" @tap="onOrderSubmit"> 提交订单 </view>
  </view>
</template>
