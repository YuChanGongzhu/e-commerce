...
<template>
  ...
  <scroll-view scroll-y class="viewport" id="myScroller" @scrolltolower="onScrolltolower">
    <template v-if="order">
      <!-- 解决?.问题 -->
      <!-- 订单状态 -->
      <view class="overview" :style="{ paddingTop: safeAreaInsets!.top + 20 + 'px' }">
        ...
        <template v-else>
          ...
          <view class="button-group">
            ...
            <view v-if="order.orderState === OrderState.DaiShouHuo" @tap="onOrderComfirm" class="button">确认收货</view>
          </view>
        </template>
      </view>
      <!-- 配送状态 -->
      ...
      <view class="goods">
        <view class="item">
          <navigator class="navigator" v-for="item in order.skus" :key="item.spuId"
      ...
      <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
        ...
        <template v-else>
          ...
          <!-- 待收货状态: 展示确认收货 -->
          <view v-if="order!.orderState === OrderState.DaiShouHuo" class="button primary" @tap="onOrderComfirm"> 确认收货
          </view>
          <!-- 待评价状态: 展示去评价 -->
