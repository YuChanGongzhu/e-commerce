...
const onChangeSex: UniHelper.RadioGroupOnChange = (e) => {
    ...
    <view class="form">
      ...
      <view class="form-content">
        ...
        <view class="form-item">
          ...
          <input class="input" type="text" placeholder="请填写昵称" v-model="memberProfile!.nickname" />
        </view>
        <view class="form-item">
        ...
        <view class="form-item">
          ...
          <input class="input" type="text" placeholder="请填写职业" :value="memberProfile?.profession" />
        </view>
      </view>
      <!-- 提交按钮 -->
