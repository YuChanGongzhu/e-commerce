...
import { ref } from 'vue'
import { getMemberAddressIdAPI, postMemberAddressAPI, putMemberAddressAPI } from "@/services/address";
...
const putMemberAddressData = async () => {
  ...
  await putMemberAddressAPI(query.id!, form.value as AddressParams)
}
...
<template>
  <view class="content">
    <uni-forms :rules="rules" :model="form" ref="formRef">
      <!-- 表单内容 -->
      <uni-forms-item name="receiver" class="form-it em">
