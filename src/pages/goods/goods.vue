...
import ServicePanel from './components/SevicePanel.vue'
...
const onChangeSkuMode = (val: SkuMode) => {
  mode.value = val
...
<template>
    ...
    <view class="goods">
      ...
      <view class="preview">
        ...
        <view class="indicator">
          <text class="current">{{ avtiveIdx + 1 }}</text>
      ...
      <!-- 操作面板 -->
      <view class="action">
        <view @tap="onChangeSkuMode(SkuMode.Both)" class="item arrow">
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    ...
    <view class="buttons">
      <view class="addcart" @tap="onChangeSkuMode(SkuMode.Cart)"> 加入购物车 </view>
      <view class="buynow" @tap="onChangeSkuMode(SkuMode.Buy)"> 立即购买 </view>
    </view>
  </view>
